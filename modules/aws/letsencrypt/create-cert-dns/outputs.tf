...
output "certificate_file_path" {
  value = "./data/certificates/${tostring(acme_certificate.certificate.common_name)}_cert.pem"
}
output "certificate_private_key_file_path" {
  value = "./data/certificates/${tostring(acme_certificate.certificate.common_name)}_privkey.pem"
}